...
The Standard header indicates whether the IEP has been adopted by an external standards
organization. The value "IEP" indicates the proposal has not been adopted by any external standard.
When an IEP is incorporated into an external standard, this field should reference the standard
(e.g., "ISO 24138:2024", "W3C DID-ISCC"). If an IEP is adopted by multiple standards, they should be
...
to reference the adopting standard(s). The Normative status indicates that the IEP content has
become part of an authoritative specification and serves as supplementary documentation to the
formal standard.
