...
- Reference implementation - A reference implementation must be completed before a **Core** IEP is
  given status **Stable**, but it need not be completed before the IEP is accepted. The stable
