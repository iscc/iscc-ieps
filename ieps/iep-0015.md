...
"target system" for ISCC declarations is a federation of existing public ledgers that support the 
declaration protocol. The protocol can be implemented on most public ledgers (even without smart 
...
!!! info
    ...
    the `controler` that can be resolved separately.
...
- ISCC DID driver: https://github.com/iscc/iscc-did-driver
