...
iscc-core 1.4.0 provides `encode_seq` (ISCC-UNIT strings to ISCC-SEQ bytes) and `decode_seq`
(ISCC-SEQ bytes to ISCC-UNIT strings) together with conformance test vectors. Entry 3 of the C2PA
...
- C2PA Technical Specification 2.4, Soft Binding assertion:
    https://spec.c2pa.org/specifications/specifications/2.4/specs/C2PA_Specification.html#soft_binding_assertion
- C2PA Soft Binding Resolution API 2.4:
